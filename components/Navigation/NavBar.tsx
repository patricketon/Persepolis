  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-10 py-4">
      <div className="flex items-center gap-8">
        ...
        <Link
          href="/explore"
          className="text-white text-lg font-light tracking-wider hover:opacity-50 transition"
          style={{ fontFamily: 'Inter, system-ui, sans-serif' }}
        >
      ...
      <SearchShell
        ...
        iconColor="black"
        className="
          px-5 py-3 w-96 rounded-full bg-white border border-black/15
          text-black placeholder:text-black placeholder:opacity-60
